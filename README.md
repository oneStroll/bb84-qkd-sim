...
基匹配数: 9 / 20  (预期 ~50%)
Alice 的 sifted key: [1 0 1 0 1 1 1 1 0]
Sifted key 长度: 9
======================================================================
...
QBER 估算样本数: 246
错误比特数: 59
量子误比特率 (QBER): 0.2398 (23.98%)
============================================================

【分析】
  无 Eve 时 QBER:  0.0000 (0.00%)
  有 Eve 时 QBER:  0.2398 (23.98%)
  理论预期（有 Eve）: ≈ 25.00%

  [OK] Eve 的存在被检测到！QBER 显著升高，通信不安全。

============================================================
大规模仿真验证（n = 50000，提高统计精度）
============================================================
